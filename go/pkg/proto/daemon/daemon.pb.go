...
var file_proto_daemon_v1_daemon_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x98, 0x04, 0x0a, 0x0d, 0x44, 0x61, 0x65, 0x6d, 0x6f, 0x6e,
	...
	0x22, 0x00, 0x12, 0x5c, 0x0a, 0x09, 0x44, 0x52, 0x4b, 0x65, 0x79, 0x4c, 0x76, 0x6c, 0x32, 0x12,
	...
	0x67, 0x6f, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x64, 0x61, 0x65,
...
var file_proto_daemon_v1_daemon_proto_goTypes = []interface{}{
	...
	(*drkey.DRKeyLvl2Request)(nil),      // 19: proto.drkey.mgmt.v1.DRKeyLvl2Request
	(*drkey.DRKeyLvl2Response)(nil),     // 20: proto.drkey.mgmt.v1.DRKeyLvl2Response
}
var file_proto_daemon_v1_daemon_proto_depIdxs = []int32{
	...
	19, // 15: proto.daemon.v1.DaemonService.DRKeyLvl2:input_type -> proto.drkey.mgmt.v1.DRKeyLvl2Request
	1,  // 16: proto.daemon.v1.DaemonService.Paths:output_type -> proto.daemon.v1.PathsResponse
	5,  // 17: proto.daemon.v1.DaemonService.AS:output_type -> proto.daemon.v1.ASResponse
	7,  // 18: proto.daemon.v1.DaemonService.Interfaces:output_type -> proto.daemon.v1.InterfacesResponse
	10, // 19: proto.daemon.v1.DaemonService.Services:output_type -> proto.daemon.v1.ServicesResponse
	15, // 20: proto.daemon.v1.DaemonService.NotifyInterfaceDown:output_type -> proto.daemon.v1.NotifyInterfaceDownResponse
	20, // 21: proto.daemon.v1.DaemonService.DRKeyLvl2:output_type -> proto.drkey.mgmt.v1.DRKeyLvl2Response
...
func (c *daemonServiceClient) DRKeyLvl2(ctx context.Context, in *drkey.DRKeyLvl2Request, opts ...grpc.CallOption) (*drkey.DRKeyLvl2Response, error) {
...
func (*UnimplementedDaemonServiceServer) DRKeyLvl2(context.Context, *drkey.DRKeyLvl2Request) (*drkey.DRKeyLvl2Response, error) {
...
func _DaemonService_DRKeyLvl2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DaemonServiceServer).DRKeyLvl2(ctx, req.(*drkey.DRKeyLvl2Request))
	}
	return interceptor(ctx, in, info, handler)
}
