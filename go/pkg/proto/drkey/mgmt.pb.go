...
type DRKeyLvl1Request struct {
	...
	ValTime   *timestamp.Timestamp `protobuf:"bytes,1,opt,name=val_time,json=valTime,proto3" json:"val_time,omitempty"`
...
type DRKeyLvl1Response struct {
	...
	EpochBegin *timestamp.Timestamp `protobuf:"bytes,1,opt,name=epoch_begin,json=epochBegin,proto3" json:"epoch_begin,omitempty"`
	EpochEnd   *timestamp.Timestamp `protobuf:"bytes,2,opt,name=epoch_end,json=epochEnd,proto3" json:"epoch_end,omitempty"`
...
type DRKeyLvl2Request struct {
	...
	ValTime  *timestamp.Timestamp        `protobuf:"bytes,3,opt,name=val_time,json=valTime,proto3" json:"val_time,omitempty"`
...
type DRKeyLvl2Response struct {
	...
	EpochBegin *timestamp.Timestamp `protobuf:"bytes,3,opt,name=epoch_begin,json=epochBegin,proto3" json:"epoch_begin,omitempty"`
	EpochEnd   *timestamp.Timestamp `protobuf:"bytes,4,opt,name=epoch_end,json=epochEnd,proto3" json:"epoch_end,omitempty"`
