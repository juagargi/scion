...
func TestCombineAll(t *testing.T) {
	cases := map[string]struct {
		...
		"tiny topo": {
			stitchable: NewStitchableSegments("1-ff00:0:111", "1-ff00:0:112",
				WithCoreASes("1-ff00:0:110", "1-ff00:0:120"),
				WithUpSegs(2),                   // src to core1
				WithDownSegs(2),                 // from core1 to dst
				WithCoreSegs(P(2, 3), P(3, 2))), // 2->3 , 3->2
			expected: NewFullTrips("1-ff00:0:111", "1-ff00:0:112",
				WithCoresInTrip("1-ff00:0:110"),
				WithTrips(T(U(0, 2), D(2, 1)))),
		},
	}
