...
// This file contains an SQLite backend for the alias DB.
...
const (
	...
	Schema = `CREATE TABLE Aliases (
		Hostname TEXT NOT NULL,
		AliasIA BIGINT  NOT NULL,
		AliasHostname TEXT  NOT NULL,
		NotAfter INTEGER,
		PRIMARY KEY (Hostname, AliasIA, AliasHostname) ON CONFLICT REPLACE
	);`
)
